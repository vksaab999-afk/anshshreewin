...
VIDEO_MSG_ID =  1050       # Tutorial Video
AUDIO_MSG_ID = 1052      # Audio Note
APK_MSG_ID =  1054         # VIP Hack File
...
async def send_welcome_content(context: ContextTypes.DEFAULT_TYPE, user_id: int, first_name: str):
    try:
        ...
        # APK file bina kisi extra custom caption ke direct copy hogi (original message jaisi hai waisi)
        await context.bot.copy_message(
            chat_id=user_id,
            from_chat_id=SOURCE_CHAT_ID,
